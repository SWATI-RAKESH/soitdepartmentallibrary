...
<br><br>
  ...
  <div class="h"><a href="expired_ino.php">Expired List</a></div>
</div>
...
<!-- <div class="container"> -->
   ...
   <?php
      if(isset($_SESSION['login_user']))
      {
        ...
        $res= mysqli_query($db,"SELECT * FROM `issue_book` where username ='$_SESSION[login_user]' and approve ='EXPIRED' ;");
